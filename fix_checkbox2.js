...
const regex = /<label class="flex items-start gap-4 cursor-pointer group">[\s\S]*?deposit before production begins\. \*<\/span>\s*<\/label>/;

const newHtml = `<label class="flex items-start gap-4 cursor-pointer group">
                  ...
                  <span class="text-sm text-charcoal/80 font-light leading-relaxed group-hover:text-charcoal transition-colors">I understand that custom-made garments require a 70% deposit before production begins. *</span>
                </label>
