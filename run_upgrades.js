...
// 3. Top bar (check if exists)
if (!$('.trust-bar-usa').length) {
    $('body').prepend(`
...
$('*').contents().each(function() {
    if(this.type === 'text') {
        ...
        // Ensure "currency" mentions are generalized (if they exist)
        // Usually, landing pages say NGN or Naira, let's just replace if found
